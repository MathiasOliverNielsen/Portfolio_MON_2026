        ...
        >
          ...
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              <div>
                <label style={{ fontSize: "0.78rem", color: "var(--muted)", display: "block", marginBottom: "0.4rem" }}>Dit navn</label>
                <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="Hvad hedder du?" required style={inputStyle} />
              </div>
              <div>
                <label style={{ fontSize: "0.78rem", color: "var(--muted)", display: "block", marginBottom: "0.4rem" }}>Email</label>
                <input type="email" name="email" value={form.email} onChange={handleChange} placeholder="din@email.dk" required style={inputStyle} />
              </div>
              <div>
                <label style={{ fontSize: "0.78rem", color: "var(--muted)", display: "block", marginBottom: "0.4rem" }}>Besked</label>
                <textarea name="message" value={form.message} onChange={handleChange} rows={4} placeholder="Hvad vil du fortælle mig?" required style={{ ...inputStyle, resize: "vertical" }} />
              </div>
              ...
              {status === "error" && <p style={{ color: "#ff6b6b", fontSize: "0.82rem" }}>Noget gik galt. Prøv igen eller send en mail direkte.</p>}
            </form>
          )}
        </div>
      </div>
